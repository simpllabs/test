    ...
    function() {
        window.promises = [], $(function() {
            ...
            return $.wait = function(e) {
                ...
                gifts: [
                    [1e3, "right", "I need a great birthday gift for a 12-year old."],
                    [1e3, "left", "Okay, let me look around for some ideas."],
                    [3e3, "left", "Here are the top rated toys:<br />Knex Tower Set - $29<Br />Snap Circuits SC-100 Kit - $45<br />Lego Mindstorms NXT set - $199."],
                    [4e3, "right", "Great, let's do the snap circuits kit."],
                    [2e3, "left", "Okay - I'll ship it to your office"],
                    [2e3, "right", "No, please rush it to 9 Lexington St, 94110."],
                    [2e3, "left", "Got it - ordering now. Receipt is in your inbox."]
                ],
                reservations: [
